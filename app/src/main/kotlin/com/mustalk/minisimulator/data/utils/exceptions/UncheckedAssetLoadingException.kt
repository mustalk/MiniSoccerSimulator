...
/**
 * [UncheckedAssetLoadingException] is a runtime exception that wraps an instance of [AssetLoadingException].
 *
 * This allows `AssetLoadingException` to be thrown in contexts where only unchecked exceptions are permitted,
 * particularly for testing purposes.
 *
